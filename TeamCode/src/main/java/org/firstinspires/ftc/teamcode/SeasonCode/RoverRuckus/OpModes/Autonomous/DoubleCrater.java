...
public class DoubleCrater extends LinearOpMode {
    ...
    {
        //Set the block state to uncertain as it has not yet been spotted
        _block = blockState.UNCERTAIN;
        secondBlockFound = false;
        //Initialize the robot
        _base.init(hardwareMap, this);
        //Calibrate the imu to 0, now it is ready to use
        ...
        //Provide telemetry to the phone and update it, so that it is immediately displayed to the phone
        sendTelemetry();
    ...
    //This function lets us condense all telemetry needed to be outputted into the a function
