...
public class WithLiftMeetDoubleCrater extends LinearOpMode {
    ...
    public void runOpMode()
    {
        ...
        _base.latchSystem.openHookandExtend(2300);
        ...
        _base.deliver.raiseMarker();
        if (_block == blockState.UNCERTAIN){
            for  (double i = 335; i < 339; i += TURN_INCREMENT - 1){
        ...
        if(_block == blockState.UNCERTAIN)
        {
            _base.drivetrain.turnTo.goTo( 33, BLOCK_TURN_SPEED);
            _base.drivetrain.turnTo.blockRunSequentially();
        ...
        {
            _base.deliver.raiseMarker();
            _base.drivetrain.turnTo.goTo(64, TURN_SPEED-0.1);
